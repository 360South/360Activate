...
/**
 * View class for a list of Displays.
 */
class DisplaysViewItems extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		DisplaysHelper::addSubmenu('items');
	...
	{
		require_once JPATH_COMPONENT.'/helpers/displays.php';

		$state	= $this->get('State');
		$canDo	= DisplaysHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_DISPLAYS_TITLE_ITEMS'), 'items.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_displays');
		}
        
        //Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_displays&view=items');
        ...
        $form = JForm::getInstance('com_displays.edit', 'edit');
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_DISPLAYS_ITEMS_TITLE'),
		'a.catid' => JText::_('COM_DISPLAYS_ITEMS_CATID'),
		);
	}
