...
if (!empty($_FILES)) {
	...
	$newPath		= $_SERVER['DOCUMENT_ROOT'] .'/images/offcuts/original/'.$newName;

	$disPath		= $_SERVER['DOCUMENT_ROOT'] .'/images/offcuts/display/'.$newName;

	$thbPath		= $_SERVER['DOCUMENT_ROOT'] .'/images/offcuts/tn/'.$newName;

	$wmImg			= $_SERVER['DOCUMENT_ROOT'] .'/administrator/components/com_offcuts/assets/blank.png';
