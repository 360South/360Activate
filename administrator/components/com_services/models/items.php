 ...
 */
class ServicesModelitems extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__services_items` AS a');
	...
	/*
		...
		$query->select('#__services_categories_563454.title AS citems_title_563454');
		$query->join('LEFT', '#__services_categories AS #__services_categories_563454 ON #__services_categories_563454.id = a.catid');
	*/
