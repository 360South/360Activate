	...
	<div class="container">
		<div class="row bg:gray-2">
			...
			<div class="col-md-6 col-xs-12 mt+2 order-xs-2 order-md-unset">
				<img src="/images/offcuts/virtual-reality/vr-circ.jpg" class="responsive-img"/>
			</div>
			<div class="col-md-6 col-xs-12 mt+2 order-xs-4 order-md-unset">
				<img src="/images/offcuts/virtual-reality/vr-plane.jpg" class="responsive-img"/>
			</div>
			...
			<div class="col-md-6 col-xs-12 mt+2 order-xs-6 order-md-unset">
				<img src="/images/offcuts/virtual-reality/vr-box.jpg" class="responsive-img"/>
			</div>
			<div class="col-md-6 col-xs-12 mt+2 order-xs-8 order-md-unset">
				<img src="/images/offcuts/virtual-reality/vr-box2.jpg" class="responsive-img"/>
			</div>
