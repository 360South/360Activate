...
class BlogModelitems extends JModelList
{
    ...
    $query->join('LEFT', '#__users AS uc ON uc.id=a.checked_out');
		...
		$query->select('#__blog_categories_563454.title AS citems_title_563454');
		$query->join('LEFT', '#__blog_categories AS #__blog_categories_563454 ON #__blog_categories_563454.id = a.catid');
