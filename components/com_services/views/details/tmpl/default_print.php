  ...
  <div class="container">
    <div class="row bg:gray-2">
      ...
      <div class="col-md-6 col-xs-12 mt+2">
        <div class="dt h+100%">
          <div class="postbox p+ bg:gray-3 dtc v-mid"> <span class="topheading">The full service</span>
            <h2>Beyond Design</h2>
      ...
      <div class="col-md-6 col-xs-12 mt+2">
      	<img src="/images/services/print/print1-bcs.jpg" class="responsive-img" />
      </div>
      <div class="col-md-6 col-xs-12 mt+2">
      	<img src="/images/services/print/print2-largejobs.jpg" class="responsive-img" />
      </div>
      <div class="col-md-6 col-xs-12 mt+2">
        <div class="dt h+100%">
