...
<div class="postheader h+100" id="parallax">
  <div class="postheader__background layer is-active" data-depth="0.30" style="background-image: url(images/projects/<?php echo ProjectHelper::getTemplate(); ?>/aircharge-hero.jpg);"> </div>
  <div class="container">
    <div class="postheader__head is-centered">
      <div class="row">
        <div class="col-md-7">
          ...
          <h1>
            <div class="oh">
              <div class="intro-title">Wireless charging  </div>
            </div>
            <div class="oh">
              <div class="intro-title">wherever you are</div>
            </div>
          </h1>
          <div class="oh tb">
  ...
  <div class="container">
    <div class="row bg:gray-2">
      <div class="col-sm-12">
          ...
          <div class="row">
            <div class="col-sm-10 col-sm-offset-1 u-text__center">
              ...
              <div class="fs+2 pt0 pb+30">
                <p>Providing over 25,000 wireless charging points around the world, AirCharge are taking advantage of a whole new marketing space for businesses by helping them generate over 2,000,000 monthly interactions across the board.</p>
              </div>
            </div>
          </div>
        </div>
		<div class="mt+2 mb+2 bg:gray-3 js-skip animate"> <div class="video-container"><iframe width="560" height="315" src="https://www.youtube.com/embed/kkwDd0UxkhA?rel=0" frameborder="0" allowfullscreen></iframe></div> </div>
        ...
        <div class="row mt+2 js-skip animate">
          <div class="col-xs-12 col-sm-6"> <img src="images/projects/<?php echo ProjectHelper::getTemplate(); ?>/aircharge-gif-01.gif" class="responsive-img" /> </div>
          <div class="col-xs-12 col-sm-6"> <img src="images/projects/<?php echo ProjectHelper::getTemplate(); ?>/aircharge-gif-02.gif" class="responsive-img" /> </div>
        </div>
        <div class="row mt+2 js-skip animate">
          <div class="col-xs-12 col-sm-6"> <img src="images/projects/<?php echo ProjectHelper::getTemplate(); ?>/aircharge-gif-03.gif" class="responsive-img" /> </div>
          <div class="col-xs-12 col-sm-6"> <img src="images/projects/<?php echo ProjectHelper::getTemplate(); ?>/aircharge-gif-04.gif" class="responsive-img" /> </div>
        </div>
