...
<main id="main" class="is-visible">
  ...
  <section id="section" class="<?php echo $option . '_' . $view; ?> home-page bg:gray-2">
    <header class="video postheader">
      <video id="videobcg" preload="auto" autoplay loop muted volume="0" poster="images/videos/hero-video-background.jpg" width="100%" height="100%">
        <source src="images/videos/introduction.mp4" type="video/mp4">
        <source src="images/videos/introduction.webm" type="video/webm">
        <source src="images/videos/introduction.ogv" type="video/ogv">
        Sorry, your browser does not support HTML5 video. </video>
      <div class="slogan">
        <h1>Activate your<br />brand with<br />
          <span class="js-typed"></span></h1>
      </div>
    </header>
    <section>
    ...
    <div class="container-fluid u-padding__0 mb+2">
	  <div class="project postbox video-image">
		<img src="/images/beretta-video.jpg" class="responsive-img" />
		<a href="https://www.youtube.com/watch?v=2zOBu_Wb7lU" target="_blank" class="trigger video__caption p+ u-zIndex__1 vertical-align">
			<div class="p+">
				<img src="/images/icons/play.svg" height="115" alt="Play" class="icon" />
			</div>
		</a>
		<span class="topheading mt+30">BERETTA AUSTRALIA</span>
		<h3 class="mt+10">AN EPIC EXPO ACTIVATION</h3>
	  </div>
	  <iframe id="modal-iframe" width="800" height="450" src="https://www.youtube.com/embed/2zOBu_Wb7lU?rel=0&controls=0&showinfo=0" frameborder="0" allowfullscreen data-izimodal-transitionin="fadeInDown"></iframe>
	</div>


    <div class="container-fluid u-padding__0">
      <div class="row u-margin__0">
        <div class="col-md-6 col-xs-12 u-display__flex component">
