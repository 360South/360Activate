 ...
 */
class ProfilesViewItems extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ProfilesHelper::addSubmenu('items');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_PROFILES_TITLE_ITEMS'), 'items.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_profiles&view=items');
	...
	protected function getSortFields()
	{
		...
		'a.checked_out' => JText::_('COM_PROFILES_ITEMS_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_PROFILES_ITEMS_CHECKED_OUT_TIME'),
		'a.created_by' => JText::_('COM_PROFILES_ITEMS_CREATED_BY'),
		'a.catid' => JText::_('COM_PROFILES_ITEMS_CATID'),
		'a.subcatid' => JText::_('COM_PROFILES_ITEMS_SUBCATID'),
		'a.title' => JText::_('COM_PROFILES_ITEMS_TITLE'),
		'a.image' => JText::_('COM_PROFILES_ITEMS_IMAGE'),
		);
	}
