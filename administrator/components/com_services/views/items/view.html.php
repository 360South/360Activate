 ...
 */
class ServicesViewItems extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ServicesHelper::addSubmenu('items');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SERVICES_TITLE_ITEMS'), 'items.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_services&view=items');
        ...
        $form = JForm::getInstance('com_services.edit', 'edit');
...
#		'a.checked_out' => JText::_('COM_SERVICES_ITEMS_CHECKED_OUT'),
#		'a.checked_out_time' => JText::_('COM_SERVICES_ITEMS_CHECKED_OUT_TIME'),
#		'a.created_by' => JText::_('COM_SERVICES_ITEMS_CREATED_BY'),
		'a.title' => JText::_('COM_SERVICES_ITEMS_TITLE'),
		'a.date' => JText::_('COM_SERVICES_ITEMS_DATE'),
		'a.catid' => JText::_('COM_SERVICES_ITEMS_CATID'),
		);
	}
