...
if (!empty($_FILES)) {
	...
	$newPath		= $_SERVER['DOCUMENT_ROOT'] .'/images/displays/original/'.$newName;

	$disPath		= $_SERVER['DOCUMENT_ROOT'] .'/images/displays/display/'.$newName;

	$thbPath		= $_SERVER['DOCUMENT_ROOT'] .'/images/displays/tn/'.$newName;

	$wmImg			= $_SERVER['DOCUMENT_ROOT'] .'/administrator/components/com_displays/assets/blank.png';
