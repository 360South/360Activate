...
/**
 * View class for a list of Requestquote.
 */
class RequestquoteViewCitems extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		RequestquoteHelper::addSubmenu('citems');
	...
	{
		require_once JPATH_COMPONENT.'/helpers/requestquote.php';

		$state	= $this->get('State');
		$canDo	= RequestquoteHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_REQUESTQUOTE_TITLE_CITEMS'), 'citems.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_requestquote');
		}
        
        //Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_requestquote&view=citems');
...
#		'a.checked_out' => JText::_('COM_REQUESTQUOTE_CITEMS_CHECKED_OUT'),
#		'a.checked_out_time' => JText::_('COM_REQUESTQUOTE_CITEMS_CHECKED_OUT_TIME'),
#		'a.created_by' => JText::_('COM_REQUESTQUOTE_CITEMS_CREATED_BY'),
		'a.firstname' => JText::_('COM_REQUESTQUOTE_CITEMS_TITLE'),
		);
	}
