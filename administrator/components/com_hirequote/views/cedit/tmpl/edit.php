...
<form action="<?php echo JRoute::_('index.php?option=com_hirequote&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="cedit-form" class="form-validate">
    ...
    <div class="span10 form-horizontal">
      ...
      <fieldset class="adminform">
        ...
        <div class="control-group">
          ...
          <div class="control-label"><?php echo $this->form->getLabel('hire'); ?></div>

          <div class="controls"><?php echo $this->form->getInput('hire'); ?></div>
