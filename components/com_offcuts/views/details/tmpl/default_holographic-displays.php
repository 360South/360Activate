...
<?php $displays = OffcutsHelper::getDisplays(); ?>
...
<div id="content">
	<div class="container">
		<div class="row bg:gray-2">
			...
			<?php $i=0;$order=1;foreach($displays as $display) : $Itemid = OffcutsHelper::getItemid($display->title); $linky = JURI::base().substr(JRoute::_('index.php?option=com_displays&Itemid='.$Itemid),strlen(JURI::base(true))+1); ?>
