...
<div class="dashboard-info">
	...
	<ul>
		...
		<li><strong><?php echo JText::_('COM_RSFIREWALL_COPYRIGHT_NAME') ?>:</strong> &copy; 2009 &mdash; <?php echo JFactory::getDate()->format('Y', true);?> <a href="https://www.rsjoomla.com" target="_blank">RSJoomla!</a></li>
