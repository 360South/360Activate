		...
		<div class="row bg:gray-2">
			<div class="col-md-12">
				<div class="postbox p+ u-offset bg:gray-3 u-text__center">
					<div class="fs+2 pt- pb-">
						<h2>Introducing the Holo Spark</h2>
						<p>Viewable from three-sides the Spark lets you combine physical product with animation and 3D holographic content creating an interactive and unique promotional tool. A key protected backdoor gives you easy access to the media player, and the display chamber.</p>
					</div>
				</div>
				<div class="mt+2 mb+2 bg:gray-3 js-skip animate"> <img src="images/displays/<?php echo DisplaysHelper::getTemplate(); ?>/spark-01.jpg" class="responsive-img" /> </div>
				<div class="postbox mt+2 p+ u-offset bg:gray-3 u-text__center">
					<div class="fs+2 pt- pb-">
						<span class="topheading mb+20">Holo Spark</span>
						<h2 class="mb+20">Specifications & Features</h2>
						<p>Easy to install and operate and beautiful to look at, Spark will grab the attention of your customers.</p>
						<div class="row mt+60 specs">
							<div class="col-md-4 col-sm-12 col-xs-12 u-text__left pr+ pb+30">
								<p><strong>Viewable Sides:</strong> 3</p>
								<p><strong>WxHxD:</strong> 680x440x540mm</p>
								<p><strong>Weight:</strong> 22kg</p>
							</div>
							<div class="col-md-4 col-sm-12 col-xs-12 u-text__left pr+ pb+30">
								<p><strong>Display:</strong> 23”</p>
							...
							<div class="col-md-4 col-sm-12 col-xs-12 u-text__left pb+30">
								<p><strong>Loud-speakers</strong></p>
									<strong>Dynamic light control</strong></p>
									<strong>Key security</strong></p>
							</div>
						</div>
					</div>
				</div>
			...
			<?php $i=0;foreach($addons as $addon) : $addon->title = preg_replace("/<span[^>]*>([\s\S]*?)<\/span[^>]*>/",'',$addon->title); ?>
				...
				<?php if ($i % 2 === 0) : ?>
					...
					<div class="col-md-6 col-xs-12 mt+2">
						<img src="/images/addons/holo-spark/<?php echo JFilterOutput::stringURLSafe($addon->title); ?>.jpg" class="responsive-img"/>
					</div>
					<?php if ($addon->title == 'Stand') : ?>
					<div class="col-md-12 col-xs-12 mt+2">
						<img src="/images/addons/holo-spark/stand-large.jpg" class="responsive-img"/>
					</div>
					<?php endif; ?>
