...
<form action="<?php echo JRoute::_('index.php?option=com_hirequote&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="edit-form" class="form-validate">
