 ...
 */
class ProjectViewCitems extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ProjectHelper::addSubmenu('citems');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_PROJECT_TITLE_CITEMS'), 'citems.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_project&view=citems');
	...
	protected function getSortFields()
	{
		...
		'a.checked_out' => JText::_('COM_PROJECT_CITEMS_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_PROJECT_CITEMS_CHECKED_OUT_TIME'),
		'a.created_by' => JText::_('COM_PROJECT_CITEMS_CREATED_BY'),
		'a.title' => JText::_('COM_PROJECT_CITEMS_TITLE'),
		);
	}
