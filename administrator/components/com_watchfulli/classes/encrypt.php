<?php
/**
 * @version     backend/classes/encrypt.php 2015-01-21 14:15:00 UTC zanardi
 ...
 * Modified for Watchfulli by Jeff Channell
 */
class WatchfulliEncrypt
{
    /**
...
// note PHP (5) gives us plaintext and password in UTF8 encoding!
    ...
    {
        if ( ! ($nBits == 128 || $nBits == 192 || $nBits == 256))
            return false;  // standard allows 128/192/256 bit keys
