...
<div id="content">
  <div class="container">
    <div class="row bg:gray-2">
      ...
      <div class="col-md-6 col-xs-12 mt+2"> <img src="/images/services/augmented-reality/ar-dino.jpg" class="responsive-img" /> </div>
      <div class="col-md-6 col-xs-12 mt+2"> <img src="/images/services/augmented-reality/ar-dino2.jpg" class="responsive-img" /> </div>
      <div class="col-md-6 col-xs-12 mt+2">
        <div class="dt h+100%">
          <div class="postbox p+ bg:gray-3 dtc v-mid">
      ...
      <div class="col-md-6 col-xs-12 mt+2">
        <div class="dt h+100%">
          <div class="postbox p+ bg:gray-3 dtc v-mid">
            ...
            <p>Get your message across with a high impact, memorable 3D animation to promote your service offerings, proven to get people talking.</p>
            <ul>
				<li>3D Animation</li>
				<li>HD Holograms</li>
			</ul>
