...
class ServicesTableedit extends JTable {
    ...
    public function bind($array, $ignore = '') {
        ...
        if(!JFactory::getUser()->authorise('core.admin', 'com_services.edit.'.$array['id'])){

            $actions = JFactory::getACL()->getActions('com_services','edit');

            $default_actions = JFactory::getACL()->getAssetRules('com_services.edit.'.$array['id'])->getData();
    ...
    */
    ...
    protected function _getAssetName() {
        ...
        return 'com_services.edit.' . (int) $this->$k;
