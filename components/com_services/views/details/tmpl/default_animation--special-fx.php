	...
	<div class="container">
		<div class="row bg:gray-2">
			<div class="col-xs-12">
				...
				<div class="mt+2">
					<a href="https://www.youtube.com/watch?v=jafjnZJ_yo8" target="_blank"> <img src="/images/services/video_fake.jpg" class="responsive-img" /> </a>
				</div>
			</div>
			...
			<div class="col-md-6 col-xs-12 order-xs-1 order-md-unset mt+2">
				<img src="/images/services/3DLogo.gif" class="responsive-img"/>
			</div>
			<div class="col-md-6 col-xs-12 order-xs-4 order-md-unset mt+2">
				<img src="/images/services/ServicesGif.gif" class="responsive-img"/>
			</div>
