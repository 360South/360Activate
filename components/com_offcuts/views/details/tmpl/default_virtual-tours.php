...
<div id="content">
  <div class="container">
    <div class="row bg:gray-2">
      ...
      <div class="col-md-6 col-xs-12 mt+2">
        <img src="/images/offcuts/virtual-tours/virtualtours-map.jpg" class="responsive-img" />
      </div>
      <div class="col-md-6 col-xs-12 mt+2">
        <img src="/images/offcuts/virtual-tours/virtualtours-interface.jpg" class="responsive-img" />
      </div>
      <div class="col-md-6 col-xs-12 mt+2">
        <div class="dt h+100%">
