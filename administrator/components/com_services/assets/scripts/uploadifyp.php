...
if (!empty($_FILES)) {
	...
	$newPath		= $_SERVER['DOCUMENT_ROOT'] .'/images/services/original/'.$newName;
	$disPath		= $_SERVER['DOCUMENT_ROOT'] .'/images/services/display/'.$newName;
	$thbPath		= $_SERVER['DOCUMENT_ROOT'] .'/images/services/tn/'.$newName;
	$wmImg			= $_SERVER['DOCUMENT_ROOT'] .'/administrator/components/com_services/assets/blank.png';
