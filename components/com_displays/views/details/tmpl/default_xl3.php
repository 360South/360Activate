		...
		<div class="row bg:gray-2">
			<div class="col-md-12">
				<div class="postbox p+ u-offset bg:gray-3 u-text__center">
					<div class="fs+2 pt- pb-">
						<h2>Introducing the XL3</h2>
						<p>With a width of 1 metre XL3 is a powerful and eye-catching marketing tool that harnesses the ability to showcase your physical product with amazing 3D animation.</p>
					</div>
				</div>
				...
				<div class="postbox mt+2 p+ u-offset bg:gray-3 u-text__center">
					<div class="fs+2 pt- pb-">
						<span class="topheading mb+20">XL3</span>
						<h2 class="mb+20">Specifications & Features</h2>
						<p>XL3 has a streamlined look and feel with improved optics quality, resulting in a crystal clear and sharp experience with an even higher level of detail.</p>
			...
			<?php $i=0;foreach($addons as $addon) : $addon->title = preg_replace("/<span[^>]*>([\s\S]*?)<\/span[^>]*>/",'',$addon->title); ?>
				...
				<?php if ($i % 2 === 0) : ?>
					...
					<div class="col-md-6 col-xs-12 mt+2">
						<img src="/images/addons/xl3/<?php echo JFilterOutput::stringURLSafe($addon->title); ?>.jpg" class="responsive-img"/>
					</div>
					<?php if ($addon->title == 'Stand') : ?>
					<div class="col-md-12 col-xs-12 mt+2">
						<img src="/images/addons/xl3/stand-large.jpg" class="responsive-img"/>
					</div>
					<?php endif; ?>
