 ...
 * View class for a list of Hirequote.

 */

class HirequoteViewCitems extends JViewLegacy

{
...

	{
		...
		HirequoteHelper::addSubmenu('citems');
...

	{
		...
		require_once JPATH_COMPONENT.'/helpers/hirequote.php';



		$state	= $this->get('State');

		$canDo	= HirequoteHelper::getActions($state->get('filter.category_id'));



		JToolBarHelper::title(JText::_('COM_HIREQUOTE_TITLE_CITEMS'), 'citems.png');
		...
		if ($canDo->get('core.admin')) {
			...
			JToolBarHelper::preferences('com_hirequote');
		...
		JHtmlSidebar::setAction('index.php?option=com_hirequote&view=citems');
...
#		'a.checked_out' => JText::_('COM_HIREQUOTE_CITEMS_CHECKED_OUT'),

#		'a.checked_out_time' => JText::_('COM_HIREQUOTE_CITEMS_CHECKED_OUT_TIME'),

#		'a.created_by' => JText::_('COM_HIREQUOTE_CITEMS_CREATED_BY'),

		'a.firstname' => JText::_('COM_HIREQUOTE_CITEMS_TITLE'),
