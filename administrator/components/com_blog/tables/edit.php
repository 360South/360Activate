 ...
 * edit Table class
 */
class BlogTableedit extends JTable {
    ...
    public function bind($array, $ignore = '') {
        ...
        if(!JFactory::getUser()->authorise('core.admin', 'com_blog.edit.'.$array['id'])){
            $actions = JFactory::getACL()->getActions('com_blog','edit');
            $default_actions = JFactory::getACL()->getAssetRules('com_blog.edit.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    */
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_blog.edit.' . (int) $this->$k;
    }
