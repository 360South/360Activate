...
(function (window, $, undefined) {
	...
	$.html5imageupload = function html5imageupload(options, element) {
		...
		//buttons
		this.button				= {}
		this.button.edit		= '<div class="btn btn-small" title="' + (this.options.editTitle || 'Edit') + '"><span class="icon-edit"></span> Edit</div>'
		this.button.saving		= '<div class="btn btn-small">' + (this.options.saveLabel || 'Saving...') + ' <span class="icon-clock"></span></div>';
		this.button.zoomin		= '<div class="btn btn-small" title="' + (this.options.zoominTitle || 'Zoom in') + '"><span class="icon-zoom-in"></span> Zoom In</div>';
		this.button.zoomout		= '<div class="btn btn-small" title="' + (this.options.zoomoutTitle || 'Zoom out') + '"><span class="icon-zoom-out"></span> Zoom Out</div>';
		this.button.zoomreset	= '<div class="btn btn-small" title="' + (this.options.zoomresetTitle || 'Fullsize') + '"><span class="icon-expand"></span> Fullscreen</div>';
...
//		this.button.rotateccw	= '<div class="btn btn-default btn-rotate-ccw" title="' + (this.options.ccwTitle || 'Rotate counter clockwise') + '"><i class="glyphicon glyphicon-share icon-flipped"></i></div>';
		this.button.cancel		= '<div class="btn btn-small" title="' + (this.options.cancelTitle || 'Cancel') + '"><span class="icon-cancel"></span> Cancel</div>';
		this.button.done		= '<div class="btn btn-small" title="' + (this.options.okTitle || 'Ok') + '"><span class="icon-save"></span> Save</div>';
		this.button.del			= '<div class="btn btn-small" title="' + (this.options.delTitle || 'Delete') + '"><span class="icon-cancel"></span> Delete</div>';
