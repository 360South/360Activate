 ...
 */
class OffcutsViewCitems extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		OffcutsHelper::addSubmenu('citems');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_OFFCUTS_TITLE_CITEMS'), 'citems.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_offcuts&view=citems');
...
#		'a.checked_out' => JText::_('COM_OFFCUTS_CITEMS_CHECKED_OUT'),
#		'a.checked_out_time' => JText::_('COM_OFFCUTS_CITEMS_CHECKED_OUT_TIME'),
#		'a.created_by' => JText::_('COM_OFFCUTS_CITEMS_CREATED_BY'),
		'a.title' => JText::_('COM_OFFCUTS_CITEMS_TITLE'),
		);
	}
