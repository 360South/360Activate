		...
		<div class="row bg:gray-2">
			<div class="col-md-12">
				<div class="postbox p+ u-offset bg:gray-3 u-text__center">
					<div class="fs+2 pt- pb-">
						<h2>Introducing the Holo Ignite</h2>
						<p>Command attention. The Ignite can be used stand alone or as part of a series to make your product stand out. This dynamic display is sized for use on shelves and counter tops providing a big impact in a small space.</p>
					</div>
				</div>
				...
				<div class="postbox mt+2 p+ u-offset bg:gray-3 u-text__center">
					<div class="fs+2 pt- pb-">
						<span class="topheading mb+20">Holo Ignite</span>
						<h2>Specifications & Features</h2>
						<p>Produced in aluminium the Ignite is sleek and stylish and can be customised to feature your brand.</p>
						<div class="row mt+60 specs">
							<div class="col-md-4 col-sm-12 col-xs-12 u-text__left pr+ pb+30">
								<p><strong>Viewable Sides:</strong> 1</p>
								<p><strong>WxHxD:</strong> 550x370x500mm</p>
			...
			<?php $i=0;foreach($addons as $addon) : $addon->title = preg_replace("/<span[^>]*>([\s\S]*?)<\/span[^>]*>/",'',$addon->title); ?>
				...
				<?php if ($i % 2 === 0) : ?>
					...
					<div class="col-md-6 col-xs-12 mt+2">
						<img src="/images/addons/holo-ignite/<?php echo JFilterOutput::stringURLSafe($addon->title); ?>.jpg" class="responsive-img"/>
					</div>
					<?php if ($addon->title == 'Stand') : ?>
					<div class="col-md-12 col-xs-12 mt+2">
						<img src="/images/addons/holo-ignite/stand-large.jpg" class="responsive-img"/>
					</div>
					<?php endif; ?>
