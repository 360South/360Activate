 ...
 * Methods supporting a list of Addons records.

 */

class AddonsModelitems extends JModelList

{
...

	{
		...
		$params = JComponentHelper::getParams('com_addons');
...

	{
		...
		$query->from('`#__addons_items` AS a');
	...
	/*
		...
		$query->select('#__addons_categories_563454.title AS citems_title_563454');

		$query->join('LEFT', '#__addons_categories AS #__addons_categories_563454 ON #__addons_categories_563454.id = a.catid');
