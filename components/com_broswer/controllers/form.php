 ...
 */
class BroswerControllerForm extends BroswerController
{
	/**
	 * Proxy for getModel.
	 * @since	1.6
	 */
	public function &getModel($name = 'Form', $prefix = 'BroswerModel')
	{
	...
	public function insertData() {
		...
		$query->clear();
		$query->insert($db->qn('#__broswer_data'))
	...
	public function submit() {
		...
		if ($validation->success == 1) :
			...
			if($sent) :
				$linky = JURI::base().substr(JRoute::_('index.php?option=com_broswer&view=form&id=1:thank-you&Itemid='.JRequest::getVar('Itemid')),strlen(JURI::base(true))+1);
				$session->clear("find");
				...
				$linky = JURI::base().substr(JRoute::_('index.php?option=com_broswer&view=form&id=2:error&Itemid='.JRequest::getVar('Itemid')),strlen(JURI::base(true))+1);
				JFactory::getApplication()->redirect( $linky );
			endif;
		else :
			$linky = JURI::base().substr(JRoute::_('index.php?option=com_broswer&view=form&id=3:code-error&Itemid='.JRequest::getVar('Itemid')),strlen(JURI::base(true))+1);
			JFactory::getApplication()->redirect( $linky );	
		endif;
