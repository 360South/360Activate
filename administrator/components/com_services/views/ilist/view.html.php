 ...
 */
class ServicesViewIlist extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ServicesHelper::addSubmenu('ilist');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SERVICES_TITLE_ILIST'), 'ilist.png');
		...
		if ($canDo->get('core.edit.state')) {
            ...
            if (isset($this->items[0]->state)) {
			    ...
			    JToolBarHelper::custom('ilist.publish', 'publish.png', 'publish_f2.png','JTOOLBAR_PUBLISH', true);
			    JToolBarHelper::custom('ilist.unpublish', 'unpublish.png', 'unpublish_f2.png', 'JTOOLBAR_UNPUBLISH', true);
            } else if (isset($this->items[0])) {
                //If this component does not use state then show a direct delete button as we can not trash
                JToolBarHelper::deleteList('', 'ilist.delete','JTOOLBAR_DELETE');
            }

            if (isset($this->items[0]->state)) {
			    JToolBarHelper::divider();
			    JToolBarHelper::archiveList('ilist.archive','JTOOLBAR_ARCHIVE');
            }
            if (isset($this->items[0]->checked_out)) {
            	JToolBarHelper::custom('ilist.checkin', 'checkin.png', 'checkin_f2.png', 'JTOOLBAR_CHECKIN', true);
            }
		}
        ...
        if (isset($this->items[0]->state)) {
		    if ($state->get('filter.state') == -2 && $canDo->get('core.delete')) {
			    JToolBarHelper::deleteList('', 'ilist.delete','JTOOLBAR_EMPTY_TRASH');
			    JToolBarHelper::divider();
		    } else if ($canDo->get('core.edit.state')) {
			    JToolBarHelper::trash('ilist.trash','JTOOLBAR_TRASH');
			    JToolBarHelper::divider();
		    }
        }
		...
		JHtmlSidebar::setAction('index.php?option=com_services&view=ilist');
        ...
        $form = JForm::getInstance('com_services.edit', 'iedit');
