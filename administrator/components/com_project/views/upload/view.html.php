 ...
 */
class ProjectViewUpload extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	public function display($tpl = null)
	{
		...
		if ($post) :
			...
			$newurl		=	'index.php?option=com_project&view=items';
		...
		ProjectHelper::addSubmenu('upload');
	...
	protected function addToolbar()
	{
		...
		$canDo	= ProjectHelper::getActions(/*$state->get('filter.category_id')*/);

		JToolBarHelper::title(JText::_('COM_PROJECT_TITLE_UPLOAD'), 'upload.png');
...
#			    JToolBarHelper::editList('upload.edit','JTOOLBAR_EDIT');
			...
			JToolBarHelper::back('Go Back','index.php?option=com_project');
...
/*		if ($canDo->get('core.admin')) {
		...
		JHtmlSidebar::setAction('index.php?option=com_project&view=upload');
	...
	protected function getSortFields()
	{
		...
		'a.checked_out' => JText::_('COM_PROJECT_ILIST_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_PROJECT_ILIST_CHECKED_OUT_TIME'),
		'a.created_by' => JText::_('COM_PROJECT_ILIST_CREATED_BY'),
		'a.title' => JText::_('COM_PROJECT_ILIST_TITLE'),
		'a.image' => JText::_('COM_PROJECT_ILIST_IMAGE'),
		);
	}
