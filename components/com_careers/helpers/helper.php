...
abstract class CareersHelper
{
	public static function vCard($items) {
		...
		foreach($items as $item) {
			...
			$vc->data['url']              = JURI::base().substr(JRoute::_('index.php?option=com_careers&view=details&id='.$item->id.':'.JFilterOutput::stringURLSafe($item->title).'&Itemid=104'),strlen(JURI::base(true))+1);
