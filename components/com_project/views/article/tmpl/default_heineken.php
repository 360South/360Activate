...
<div class="postheader h+100" id="parallax">
  <div class="postheader__background layer is-active" data-depth="0.30" style="background-image: url(images/projects/<?php echo ProjectHelper::getTemplate(); ?>/heineken-01.jpg);"> </div>
  <div class="container">
    <div class="postheader__head is-centered">
      <div class="row">
        <div class="col-md-7">
          ...
          <h1>
            <div class="oh">
              <div class="intro-title">Open your world</div>
            </div>
          </h1>
          <div class="oh tb">
    ...
    <div class="row bg:gray-2">
      <div class="col-sm-12">
          ...
          <div class="row">
            <div class="col-sm-10 col-sm-offset-1 u-text__center">
              ...
              <div class="fs+2 pt0 pb+30">
                <p>360Activate created a holographic marketing solution incorporating props, 3D animation and a refrigerated product stand. This campaign helped to boost Heineken beer sales through the power of intrigue.</p>
              </div>
            </div>
          </div>
        </div>
		<div class="mt+2 mb+2 bg:gray-3 js-skip animate"> <div class="video-container"><iframe width="560" height="315" src="https://www.youtube.com/embed/-WxEO77LIsg" frameborder="0" allowfullscreen></iframe> </div></div>
          ...
          <div class="col-sm-12 col-xs-12">
            <div class="postbox p+ bg:gray-3">
              <div class="row">
                ...
                <div class="col-sm-5">
					<p>The <a href="https://www.360activate.com.au/solutions/holographic-displays/holo-ignite.html">Holo Ignite</a> single-sided display was perfect for the Heineken - Open Your World campaign. The large internal space of the Ignite allowed the easy construction and placement of custom physical props. Complemented by a beer fridge stand, the holographic display depicts a chilled bottle of ice cold beer brought to life with animation amongst mounds of ice. </p>
					<p>Combining 3D animation and physical objects together created an exciting result. Life-like bubbles rise-up from the bottle giving the appearance of everlasting freshness, while magical starbursts appear and spin around the bottle. Using Ignite’s custom lighting effects allowed for a relaxed and refreshing atmosphere inside, enticing customers.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row mt+2 js-skip animate is-animated">
          <div class="col-xs-12 col-sm-6"> <img src="images/projects/<?php echo ProjectHelper::getTemplate(); ?>/heineken-03.jpg" class="responsive-img" /> </div>
          <div class="col-xs-12 col-sm-6"> <img src="images/projects/<?php echo ProjectHelper::getTemplate(); ?>/heineken-04.jpg" class="responsive-img" /> </div>
        </div>
        <div class="mt+2 mb+2 bg:gray-3 js-skip animate"> <img src="images/projects/<?php echo ProjectHelper::getTemplate(); ?>/heineken-02.jpg" class="responsive-img" /> </div>
      </div>
    </div>
  </div>
  <div class="container">
