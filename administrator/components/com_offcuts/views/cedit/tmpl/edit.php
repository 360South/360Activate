...
<form action="<?php echo JRoute::_('index.php?option=com_offcuts&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="cedit-form" class="form-validate">
