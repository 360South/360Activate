<?php defined('_JEXEC') or die; $prevnext = ServicesHelper::getPrevNext(); $linky = JRoute::_( 'index.php?option=com_requestquote&Itemid=108' ); $video = JRoute::_( 'index.php?option=com_services&Itemid=125' ); ?>
...
<div id="content">
  <div class="container">
    <div class="row bg:gray-2">
      ...
      <div class="col-md-6 col-xs-12 mt+2">
      	<img src="/images/services/video/video-camera.jpg" class="responsive-img" />
      </div>
      ...
      <div class="col-md-6 col-xs-12 mt+2">
        <img src="/images/services/video/video-paul.jpg" class="responsive-img" />
      </div>
      <div class="col-md-6 col-xs-12 mt+2">
        <div class="dt h+100%">
