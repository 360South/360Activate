 ...
 * iedit Table class
 */
class BlogTableiedit extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__blog_images', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
        ...
        if(!JFactory::getUser()->authorise('core.admin', 'com_blog.iedit.'.$array['id'])){
            $actions = JFactory::getACL()->getActions('com_blog','iedit');
            $default_actions = JFactory::getACL()->getAssetRules('com_blog.iedit.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    */
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_blog.iedit.' . (int) $this->$k;
    }
