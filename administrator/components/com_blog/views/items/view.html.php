...
class BlogViewItems extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_BLOG_TITLE_ITEMS'), 'items.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_blog&view=items');
        ...
        $form = JForm::getInstance('com_blog.edit', 'edit');
...
#		'a.checked_out' => JText::_('COM_BLOG_ITEMS_CHECKED_OUT'),
#		'a.checked_out_time' => JText::_('COM_BLOG_ITEMS_CHECKED_OUT_TIME'),
#		'a.created_by' => JText::_('COM_BLOG_ITEMS_CREATED_BY'),
		'a.title' => JText::_('COM_BLOG_ITEMS_TITLE'),
		'a.date' => JText::_('COM_BLOG_ITEMS_DATE'),
		'a.catid' => JText::_('COM_BLOG_ITEMS_CATID'),
		);
	}
