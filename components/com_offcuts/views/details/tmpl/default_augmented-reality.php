...
<div id="content">
	<div class="container">
		<div class="row bg:gray-2">
			...
			<div class="col-md-6 col-xs-12 mt+2 order-xs-2 order-md-unset"> <img src="/images/offcuts/augmented-reality/ar-dino.jpg" class="responsive-img"/> </div>
			<div class="col-md-6 col-xs-12 mt+2 order-xs-4 order-md-unset"> <img src="/images/offcuts/augmented-reality/ar-dino2.jpg" class="responsive-img"/> </div>
	...
	C166,107.7,157.9,100.5,147.7,100.5"/>
			...
			<div class="col-md-6 col-xs-12 mt+2 order-xs-6 order-md-unset"> <img src="/images/offcuts/augmented-reality/ar-melba.jpg" class="responsive-img"/> </div>
				...
				<div class="row w-100 u-margin__0">
					<div class="col-xs-12 col-md-4 u-display__flex mb+2">
				  		<span class="postbox p+ bg:gray-1 u-text__center">
					  		...
					  		<img src="images/offcuts/augmented-reality/app.png" class="mt+b mb+20" />
					...
					<div class="col-xs-12 col-md-4 u-display__flex mb+2"> <a class="postbox p+ bg:gray-1 hover/bg:gray-2 u-text__center" href="/design-offcuts-melbourne/360artarget.pdf" target="_blank">
		...
		l-4.3,41.3H82.6c-13.2-16.2-13.5-50.2-13.5-82.9v-2.8H69.5z"/>
					...
					<div class="col-xs-12 col-md-4 u-display__flex mb+2">
						<div class="postbox p+ bg:gray-1 u-text__center">
							...
							<img src="images/offcuts/augmented-reality/augmented-reality-01.jpg" class="mt+b"/> </div>
					</div>
				</div>
			</div>

			<!-- <div class="col-md-12">
        <div class="mt+2"> <a href="http://www.360south.com.au/design-offcuts-melbourne/360artarget.pdf" target="_blank"> <img src="/images/offcuts/ar-brochures.jpg" class="responsive-img" /> </a> </div>
        <div class="mt+2"> <a href="http://www.360south.com.au/design-offcuts-melbourne/360artarget.pdf" target="_blank"> <img src="/images/offcuts/ar-brochures2.jpg" class="responsive-img" /> </a> </div>
      </div> -->
		</div>
	</div>
