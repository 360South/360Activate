...
/**
 * Methods supporting a list of Displays records.
 */
class DisplaysModelitems extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Load the parameters.
		$params = JComponentHelper::getParams('com_displays');
	 ...
	 *
	 * This is necessary because the model is used by the component an
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__displays_items` AS a');
	...
	/*
		...
		$query->select('#__displays_categories_563454.title AS citems_title_563454');
		$query->join('LEFT', '#__displays_categories AS #__displays_categories_563454 ON #__displays_categories_563454.id = a.catid');
	*/
