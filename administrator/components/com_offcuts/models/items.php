 ...
 * Methods supporting a list of Offcuts records.

 */

class OffcutsModelitems extends JModelList

{
...

	{
		...
		$params = JComponentHelper::getParams('com_offcuts');
...

	{
		...
		$query->from('`#__offcuts_items` AS a');
	...
	/*
		...
		$query->select('#__offcuts_categories_563454.title AS citems_title_563454');

		$query->join('LEFT', '#__offcuts_categories AS #__offcuts_categories_563454 ON #__offcuts_categories_563454.id = a.catid');
