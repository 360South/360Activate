...
<form action="<?php echo JRoute::_('index.php?option=com_services&view=iupload'); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="iupload-form" class="form-validate">
  <div class="row-fluid">
...
jQuery("#uploadify").uploadify({
    ...
    'uploader'       	: '/administrator/components/com_services/assets/scripts/uploadifyp.php',
    'queueID'         	: 'queue',
    'auto'          	: true,
    'multi'           	: true,
	'queueID'			: 'queue',
    ...
    'fileTypeExts'		: '*.jpg',
    'fileSizeLimit'   	: '10MB',
    'checkExisting' 	: '/administrator/components/com_services/assets/scripts/check-existsp.php',
	'removeCompleted'	: false,
    'method' 			: 'post',
    'formData' 			: { 'catid' : ''+jQuery('#catid').val()+'' },
