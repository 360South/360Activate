	...
	<div class="container">
		<div class="row bg:gray-2">
			<div class="col-md-12">
				<div class="postbox p+ u-offset bg:gray-3 u-text__center">
					<div class="fs+2 pt- pb-">
						<h2>Introducing the Holo Inferno</h2>
						<p>The Inferno is a gigantic four-sided holographic display that is guaranteed to attract passers-by from all angles.</p>
					</div>
				</div>
				...
				<div class="postbox mt+2 p+ u-offset bg:gray-3 u-text__center">
					<div class="fs+2 pt- pb-">
						<span class="topheading mb+20">Holo Inferno</span>
						...
						<div class="row mt+60 specs">
							<div class="col-md-4 col-sm-12 col-xs-12 u-text__left pr+ pb+30">
								...
								<p><strong>WxHxD:</strong> 1980x1952x1780mm</p>
			...
			<div class="col-md-6 col-xs-12 mt+2">
				<img src="/images/addons/holo-inferno/case.jpg" class="responsive-img"/>
			</div>
			<div class="col-md-6 col-xs-12 mt+2">
				<div class="dt h+100%">
					<div class="postbox p+ bg:gray-3 dtc v-mid"> 
						...
						<p>We include a Holo Inferno flightcase for easy transportation and piece of mind.</p>
					</div>
				</div>
			</div>
			...
			<?php $i=0;foreach($addons as $addon) : $addon->title = preg_replace("/<span[^>]*>([\s\S]*?)<\/span[^>]*>/",'',$addon->title); ?>
				...
				<?php if ($i % 2 === 0) : ?>
					...
					<div class="col-md-6 col-xs-12 mt+2">
						<img src="/images/addons/holo-inferno/<?php echo JFilterOutput::stringURLSafe($addon->title); ?>.jpg" class="responsive-img"/>
					</div>
					<?php if ($addon->title == 'Stand') : ?>
					<div class="col-md-12 col-xs-12 mt+2">
						<img src="/images/addons/holo-inferno/stand-large.jpg" class="responsive-img"/>
					</div>
					<?php endif; ?>
